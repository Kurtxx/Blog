...
from blog.users.forms import RegistratonForm,LoginForm,UpdateUserForm
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Twoje Konto zostało zaktualizowane!')
